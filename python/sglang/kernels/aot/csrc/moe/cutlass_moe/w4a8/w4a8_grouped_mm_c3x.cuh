...
struct RingOperandMainloop : Base {
  ...
  CUTLASS_DEVICE void mma(
    ...
    this->template mma_with_released_stage_producer<FrgTensorC, typename Base::NoopReleasedStageProducer, 8>(
...
struct cutlass_3x_w4a8_group_gemm {
  ...
  using CollectiveMainloopScaleOnly = std::conditional_t<
      UseRingOperands, RingOperandMainloop<CollectiveMainloopBase>, CollectiveMainloopBase>;
