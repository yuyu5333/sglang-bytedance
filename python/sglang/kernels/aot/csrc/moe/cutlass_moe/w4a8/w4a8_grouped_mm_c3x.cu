...
struct SM90_SWG_MXFP4 {
  using TileShape = cute::Shape<cute::Int<M>, cute::Int<N>, cute::Int<128>>;
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 371:
      ...
      return;
    case 372:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_SWG_MXFP4<16, 256>));
      return;
    default:
      TORCH_CHECK(
          false,
          ...
          swg_config,
          "; expected one of 100, 101, 204, 205, 313, 320, 322, 334, 364, 366, 367, 371, 372");
  }
}
