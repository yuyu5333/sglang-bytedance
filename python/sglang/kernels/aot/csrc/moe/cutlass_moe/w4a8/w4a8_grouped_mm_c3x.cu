...
struct SM90_DRAINED_K256_SWG_MXFP4 {
  using Base = typename SM90_PRECOMPUTED_MXFP4<128, N, 256>::Cutlass3xW4A8Gemm;
  struct Cutlass3xW4A8Gemm : Base {
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 405:
      ...
      return;
    case 438:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_DRAINED_K256_SWG_MXFP4<16, 3, 3>));
      return;
    case 439:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_DRAINED_K256_SWG_MXFP4<32, 3, 2>));
      return;
    case 440:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_DRAINED_K256_SWG_MXFP4<64, 2, 2>));
      return;
    default:
      TORCH_CHECK(
          false,
