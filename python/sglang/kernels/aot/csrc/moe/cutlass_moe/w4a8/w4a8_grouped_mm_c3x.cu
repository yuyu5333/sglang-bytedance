...
struct SM90_C64_K512_SWG_MXFP4 {
  using Base = typename SM90_PRECOMPUTED_MXFP4<64, N, 512>::Cutlass3xW4A8Gemm;
  struct Cutlass3xW4A8Gemm : Base {
    static constexpr bool UseSingleWarpgroupKernel = true;
    static constexpr int SingleWarpgroupCtasPerSm = Ctas;
    using TileShape = cute::Shape<cute::Int<64>, cute::Int<N>, cute::Int<512>>;
    using OldMainloop = typename Base::CollectiveMainloopScaleOnly;
    using Policy = cutlass::gemm::MainloopSm90ArrayTmaGmmaWarpSpecializedMixedInputPreScale<
    ...
    using CollectiveMainloopScaleOnly = cutlass::gemm::collective::CollectiveMmaArrayMixedInput<
        ...
        typename OldMainloop::SmemLayoutAtomB,
        typename OldMainloop::SmemCopyAtomB,
        cutlass::gemm::collective::DrainedK512StageRefill>;
    using CollectiveEpilogue = typename sgl_kernel::w4a8_detail::W4A8EpilogueSelector<
        true,
        true,
        false,
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 441:
      ...
      return;
    case 445:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_C64_K512_SWG_MXFP4<32, 3, 2>));
      return;
    case 446:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_C64_K512_SWG_MXFP4<32, 2, 3>));
      return;
    case 447:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_C64_K512_SWG_MXFP4<64, 2, 2>));
      return;
    default:
      TORCH_CHECK(
          false,
