...
struct SM90_FIXED_RF_N64_MXFP4 {
  ...
  struct Cutlass3xW4A8Gemm : Base {
    static constexpr auto ExpertRows = Rows == 128 ? sgl_kernel::swg_detail::ExpertRowPolicy::MainN128
                                                  : sgl_kernel::swg_detail::ExpertRowPolicy::MainN64;
    using OldMainloop = typename Base::CollectiveMainloopScaleOnly;
    using Policy = cutlass::gemm::MainloopSm90ArrayTmaGmmaWarpSpecializedMixedInputPreScale<
    ...
    using GemmKernelScaleOnly = cutlass::gemm::kernel::GemmUniversalPrecomputedScheduler<
        ...
        typename Base::PrecomputedTileScheduler>;
    static_assert(
        ((Stages == 3 || Stages == 4) && Ctas == 2 &&
         ((Channels == 128 && Rows == 64) || (Channels == 64 && Rows == 128))) ||
        (Stages == 6 && Channels == 64 && Rows == 64 && Ctas == 2));
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 664:
      ...
      return;
    case 665:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_SHORT_EPILOGUE_MXFP4<SM90_FIXED_RF_N64_MXFP4<3, 64, 2, 128>, 8>));
      INVOKE_GEMM_WITH_CONFIG_AS(
      ...
      return;
    case 666:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_SHORT_EPILOGUE_MXFP4<SM90_FIXED_RF_N64_MXFP4<4, 64, 2, 128>, 8>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_TWO_CTA_PINGPONG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN64Of128>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
      ...
      return;
    case 667:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_SHORT_EPILOGUE_MXFP4<SM90_FIXED_RF_N64_MXFP4<6, 64, 2>, 8>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              128, 32, 512, 1, 1, false, sgl_kernel::swg_detail::ExpertRowPolicy::TailN32Of64>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
    ...
    default:
      TORCH_CHECK(
          ...
          "608, 616, 645, 649, 663, 664, 665, 666, 667");
  }
}
