...
template <class BaseConfig, int L2Distance = 0, bool CommitEight = false>
struct SM90_GLOBAL_ACTIVATION_TMA_MXFP4 {
  ...
  struct Cutlass3xW4A8Gemm : Base {
    ...
    using Mainloop = cutlass::gemm::collective::CollectiveMmaArrayMixedInput<
        ...
        typename OldMainloop::SmemCopyAtomB,
        std::conditional_t<
            CommitEight, cutlass::gemm::collective::CommitEightK32, typename OldMainloop::TransformB>>;
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 536:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<128, 32, 256, 1, 1, false>>));
      return;
    case 537:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<128, 32, 256, 1, 1, true>>));
      return;
    default:
      TORCH_CHECK(
          false,
          ...
          "441, 448, 449, 460, 470, 471, 473, 474, 475, 476, 483, 503, 518, 534, 535, 536, 537");
  }
}
