...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 561:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              256, 32, 256, 1, 1, false, sgl_kernel::swg_detail::ExpertRowPolicy::MainN32>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_N16_K256_SWG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN16>>));
      return;
    case 562:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              256, 32, 128, 1, 1, false, sgl_kernel::swg_detail::ExpertRowPolicy::MainN32>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_N16_K256_SWG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN16>>));
      return;
    case 563:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              256, 32, 256, 1, 1, true, sgl_kernel::swg_detail::ExpertRowPolicy::MainN32>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_N16_K256_SWG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN16>>));
      return;
    case 564:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              128, 48, 256, 1, 1, false, sgl_kernel::swg_detail::ExpertRowPolicy::MainN48>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_N16_K256_SWG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN16Of48>>));
      return;
    case 565:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
              128, 48, 512, 1, 1, false, sgl_kernel::swg_detail::ExpertRowPolicy::MainN48>>));
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_N16_K256_SWG_MXFP4<sgl_kernel::swg_detail::ExpertRowPolicy::TailN16Of48>>));
      return;
    default:
      TORCH_CHECK(
          ...
          "441, 448, 449, 460, 470, 471, 473, 474, 475, 476, 483, 503, 518, 561, 562, 563, 564, 565");
  }
}
