...
template <int N>
struct SM90_DIRECT_WEIGHT_MXFP4 {
  ...
  struct Cutlass3xW4A8Gemm : Base {
    ...
    using CollectiveMainloopScaleOnly = cutlass::gemm::collective::CollectiveMmaArrayMixedInput<
        ...
        cutlass::gemm::collective::DirectGlobalPackedWeight,
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 364:
      ...
      return;
    case 387:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_DIRECT_WEIGHT_MXFP4<8>));
      return;
    case 388:
      INVOKE_GEMM_WITH_CONFIG_AS((SM90_DIRECT_WEIGHT_MXFP4<16>));
      return;
    default:
      TORCH_CHECK(
          false,
          ...
          swg_config,
          "; expected one of 100, 101, 204, 205, 313, 320, 322, 334, 364, 387, 388");
  }
}
