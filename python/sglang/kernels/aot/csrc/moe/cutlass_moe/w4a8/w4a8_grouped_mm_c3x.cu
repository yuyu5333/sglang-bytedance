...
template <class BaseConfig, int L2Distance = 0, bool MergeKTail = false>
struct SM90_GLOBAL_ACTIVATION_TMA_MXFP4 {
  ...
  struct Cutlass3xW4A8Gemm : Base {
    ...
    using Mainloop = cutlass::gemm::collective::CollectiveMmaArrayMixedInput<
        ...
        typename OldMainloop::SmemCopyAtomB,
        std::conditional_t<
            MergeKTail, cutlass::gemm::collective::MergedKTailLoop, typename OldMainloop::TransformB>>;
...
void dispatch_mxfp4a8_fused_moe_mm_sm90(
  ...
  switch (swg_config) {
    ...
    case 525:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_WARP_METADATA_MXFP4<SM90_TAIL_HANDOFF_MXFP4<
              SM90_PRECOMPUTED_MXFP4<128, 16, 512, 1, 1, true>>>));
      return;
    case 526:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_WARP_METADATA_MXFP4<SM90_TAIL_HANDOFF_MXFP4<
              SM90_PRECOMPUTED_MXFP4<128, 16, 512, 1, 1, false>>>));
      return;
    case 527:
      INVOKE_GEMM_WITH_CONFIG_AS(
          (SM90_GLOBAL_ACTIVATION_TMA_MXFP4<SM90_PRECOMPUTED_MXFP4<
    ...
    default:
      TORCH_CHECK(
          ...
          "441, 448, 449, 460, 470, 471, 473, 474, 475, 476, 483, 503, 517, 518, 525, 526, 527, 528");
  }
}
