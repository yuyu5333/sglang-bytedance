...
class Envs:
    ...
    # Reuse immutable decode metadata across the c4/c128 compressor calls
    # within one ForwardBatch. Disabled by default for A/B validation.
    SGLANG_DSV4_CACHE_DECODE_METADATA = EnvBool(False)
